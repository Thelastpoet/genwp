...
const OpenAISettings = () => {
  ...
  const fetchSettings = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(async () => {
    try {
      let loadedSettings = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.fetchFromLocalStorage)('genwp-settings');
      if (!loadedSettings) {
        loadedSettings = await _services_api__WEBPACK_IMPORTED_MODULE_3__["default"].fetchSettings();
        (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.saveToLocalStorage)('genwp-settings', loadedSettings);
      }
  ...
  const handleSubmit = async e => {
    ...
    setStatus('saving');
    try {
      await _services_api__WEBPACK_IMPORTED_MODULE_3__["default"].saveSettings(settings);
      (0,_utils_utils__WEBPACK_IMPORTED_MODULE_2__.saveToLocalStorage)('genwp-settings', settings);
      setStatus('saved');
      fetchSettings();
    } catch (error) {
      setStatus('failed');
