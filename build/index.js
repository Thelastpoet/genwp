...
const ArticleSettings = props => {
  ...
  const fetchAuthors = async () => {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_2___default().get(`${genwpLocal.apiURL}/genwp/v1/authors`);
  ...
  const fetchPostTypes = async () => {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_2___default().get(`${genwpLocal.apiURL}/genwp/v1/types`);
  ...
  const fetchPostStatuses = async () => {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_2___default().get(`${genwpLocal.apiURL}/genwp/v1/statuses`);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "wrap p-8 bg-white rounded shadow-lg w-full"
...
const KeywordsTable = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const keywordsData = await _services_api__WEBPACK_IMPORTED_MODULE_3__["default"].getKeywords(currentPage, itemsPerPage);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "container mx-auto p-4 space-y-4 w-full"
  ...
  }, keywords.map(keyword => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("tr", {
    key: keyword.id,
    ...
    className: "px-6 py-4"
  }, editingKeywordId === keyword.id ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    ...
    className: "bg-red-400 hover:bg-gray-500 text-white px-4 py-2 rounded"
...
const Pagination = ({
  ...
  }, "Page ", currentPage, " of ", totalPages), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    onClick: () => onPageChange(currentPage + 1),
...
const OpenAISettings = props => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "font-medium mb-2"
  }, "OpenAI API Key"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "flex items-center"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-96"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    name: "genwp-openai-api-key",
    value: apiKeyValue('genwp-openai-api-key'),
    onChange: handleChange,
    readOnly: !showOpenAIKey,
    ...
    className: "ml-2 px-4 py-2 bg-blue-500 text-white hover:bg-blue-600 rounded cursor-pointer"
  }, showOpenAIKey ? 'Hide Key' : 'Show Key'))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "flex flex-col mb-4"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("label", {
    className: "font-medium mb-2"
  }, "OpenAI Model"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-96"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    name: "model",
    ...
    className: "font-medium mb-2"
  }, "Maximum Tokens"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-96"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "number",
    name: "max_tokens",
    ...
    className: "font-medium mb-2"
  }, "Temperature"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-96"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "number",
    step: "0.01",
    ...
    className: "font-medium mb-2"
  }, "Top P"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-96"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "number",
    step: "0.01",
    ...
    className: "font-medium mb-2"
  }, "Frequency Penalty"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-96"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "number",
    step: "0.1",
    ...
    className: "font-medium mb-2"
  }, "Presence Penalty"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-96"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "number",
    step: "0.1",
    ...
    className: "font-medium mb-2"
  }, "Pexels API Key"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "flex items-center"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-96"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    name: "pexels_api_key",
    value: apiKeyValue('pexels_api_key'),
    onChange: handleChange,
    readOnly: !showPexelsKey,
    placeholder: "Enter your API key",
    className: "border p-2 rounded w-full focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    type: "button",
    onClick: togglePexelsKeyVisibility,
    className: "ml-2 px-4 py-2 bg-blue-500 text-white hover:bg-blue-600 rounded cursor-pointer"
  }, showPexelsKey ? 'Hide Key' : 'Show Key'))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "submit",
    value: getButtonText(),
    className: "px-4 py-2 bg-blue-500 text-white hover:bg-blue-600 rounded cursor-pointer"
  }))));
...
/* harmony import */ var _GenKeyTable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./GenKeyTable */ "./src/components/GenKeyTable.js");
...
const Settings = () => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
    ...
    className: "flex bg-matte-black mb-4"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    ...
    settings: settings
  }), activeTab === 'uploadKeywords' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_UploadKeywords__WEBPACK_IMPORTED_MODULE_4__["default"], null), activeTab === 'keywordsTable' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_GenKeyTable__WEBPACK_IMPORTED_MODULE_5__["default"], null))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-1/4 p-4 border-l"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Placeholder text for the sidebar."))));
};
...
const UploadKeywords = () => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "wrap genwp-wrap p-8 bg-white flex flex-col items-center rounded shadow-lg w-full"
